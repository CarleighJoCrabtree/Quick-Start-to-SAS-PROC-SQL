...
/* Creat out.stateProductLines to use for summary functions.                   */
...
/* Calculate the maximum, minimum and average number of orders placed for the Assorted product line. */
proc sql;
...
/* Calculate the maximum, minimum and average number of orders placed across all product lines for each state. */
...
/* Use data driven macros and dictionar.columns to put column names in a macro variable list separated by commas.  */
proc sql;
select name
